...
│   ├── umap_label.parquet        # (not in repo) primary label file
│   ├── umap_label2.parquet       # (not in repo) secondary label file
│   ├── cluster_colors.csv        # (not in repo) custom colours for the Cluster ID set
